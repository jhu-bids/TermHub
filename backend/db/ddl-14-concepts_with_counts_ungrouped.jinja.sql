...
CREATE INDEX IF NOT EXISTS ccu_idx1 ON {{schema}}concepts_with_counts_ungrouped(concept_id);
--CREATE INDEX IF NOT EXISTS ccu_idx2 ON concepts_with_counts_ungrouped(concept_id);