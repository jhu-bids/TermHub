...
function DownloadJSON(props) {
  const [bundles_widget, bundles_props] = useDataWidget(
    "bundles",
    "enclave-api-call/get_bundle_names"
  );
  const n3c_csets_url = "get-n3c-recommended-codeset_ids";
  const [n3c_csets_data_widget, n3cprops] = useDataWidget(
    "n3c-csets",
    n3c_csets_url
  );
  ...
  return (
    <div>
      ...
      If you get a warning message about STANDARD_CONCEPT_CAPTION or
      INVALID_REASON_CAPTION, proceed without concern.
    </div>
  );
}
