    ...
    return (
        <div style={{ margin: '15px 30px 15px 40px' }}>
            ...
            <ol>
                ...
                <LI>File a report: via <a href="https://github.com/jhu-bids/termhub/issues/new/choose" target="_blank"
...
DOCS.blank_search_intro = (
    ...
    */}
            ...
            <ul>
                ...
                <LI>Provide feedback by creating a <a href="https://github.com/jhu-bids/termhub/issues/new/choose"
...
function ViewBundleReport() {
    ...
    useEffect(() => {
        (async () => {
            ...
            try {
                const _bundles = await dataGetter.axiosCall('get-bundle-names', { sendAlert: false });
                setBundles(_bundles);
            } catch (error) {
    ...
    return (
        <Autocomplete
            ...
            renderInput={(params) => <TextField {...params} label="View a bundle report"/>}
